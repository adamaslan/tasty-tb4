  ...
  return (
    <div>
      <div className=" mx-3 lg:mx-36">
        <h1 className="tracking-light text-center text-2xl font-extrabold text-blue-500 sm:text-4xl lg:text-7xl">
        ...
        <p className="text-left text-xl  tracking-tight sm:text-2xl lg:text-4xl">
          ...
          challenging thing to say with the rise of NodeJS and the developments
          of HTML5.{" "}
        </p>
        <br />{" "}
        <p className="text-left text-xl  tracking-tight sm:text-2xl lg:text-4xl">
          ...
          to say JS is the only way to do form validation on the world wide web
          and people are really leaning into shipping less JS these days so
          maybe it's time to dive even deeper into html form validation.
        </p>
      </div>
