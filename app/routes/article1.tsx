...
export default function Article1() {
  return (
    <div>
      ...
      <h1 className="text-center text-2xl font-extrabold tracking-light sm:text-4xl lg:text-5xl text-blue-500 mx-10">4 Weird Things about the Internet </h1>
        <img
      ...
      <div>
        ...
        <ol className="text-left text-xl font-extrabold tracking-tight sm:text-2xl lg:text-2xl">
          <li className="pb-2">1. Before internet, there was ARPANET and packet switching.</li>
          <li className="pb-2">
            2. The word Internet was first used in 1974 and is short for
            internetwork.
          </li>
          <li className="pb-2">3. Internet used to be capitalized more, lol.</li>
          <li className="pb-2">
