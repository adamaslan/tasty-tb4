...
function ModelsTablePage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "max-w-7xl mx-auto p-4", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("section", { className: "bg-white shadow-sm rounded-xl overflow-hidden", children: [
    /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "px-6 py-4 border-b border-gray-200", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("h1", { className: "text-2xl font-bold", children: "Registered AI Models" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "overflow-x-auto", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("table", { className: "w-full", children: [
      /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("thead", { className: "bg-gray-50", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("tr", { children: ["Name", "Type", "Parameters", "Experts", "Context Window", "Release Date"].map((header) => (
      ...
      /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("tbody", { className: "divide-y divide-gray-200", children: Array.isArray(models) && models.map((model) => /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("tr", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500", children: [
          model.release_date ? new Date(model.release_date).toLocaleDateString() : "N/A",
          " "
        ] })
      ] }, model.id)) })
    ] }) }),
    (!Array.isArray(models) || models.length === 0) && /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("p", { className: "px-6 py-4 text-center text-gray-500", children: "No models found." })
  ] }) });
}
...
function Index() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: "max-w-7xl mx-auto p-4", children: [
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("section", { className: "mb-12 bg-white shadow-sm rounded-xl p-6", children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("h2", { className: "text-2xl font-bold mb-6", children: "Register New AI Model" }),
      (actionData == null ? void 0 : actionData.error) && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("p", { className: "text-red-500 mb-4", children: actionData.error }),
      actionData && !actionData.error && transition.state === "idle" && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("p", { className: "text-green-500 mb-4", children: "Model registered successfully!" }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(import_react29.Form, { method: "post", className: "space-y-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: ["name", "type", "parameter_count", "experts", "context_window_tokens"].map((field) => /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("label", { className: "block text-sm font-medium capitalize mb-2", children: field.replace(/_/g, " ") }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("section", { className: "bg-white shadow-sm rounded-xl overflow-hidden", children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "px-6 py-4 border-b border-gray-200", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("h2", { className: "text-xl font-semibold", children: "Registered Models" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "overflow-x-auto", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("table", { className: "w-full", children: [
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("thead", { className: "bg-gray-50", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("tr", { children: ["Name", "Type", "Parameters", "Experts", "Context Window", "Release Date"].map((header) => (
          // Changed from Created At
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
            "th",
            {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("tbody", { className: "divide-y divide-gray-200", children: Array.isArray(models) && models.map((model) => /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("tr", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("td", { className: "px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900", children: model.name }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500", children: model.type }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500", children: (model.parameter_count ?? 0).toLocaleString() }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500", children: model.experts ?? "N/A" }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500", children: (model.context_window_tokens ?? 0).toLocaleString() }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500", children: [
            model.release_date ? new Date(model.release_date).toLocaleDateString() : "N/A",
            " "
          ] })
        ] }, model.id)) })
      ] }) }),
      (!Array.isArray(models) || models.length === 0) && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("p", { className: "px-6 py-4 text-center text-gray-500", children: "No models registered yet." })
    ] })
  ] });
}
...
function Art2() {
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("main", { className: " items-left justify-left mx-4 min-h-screen bg-white lg:mx-36 md:mx-16", children: [
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "text-left text-xl font-extrabold tracking-tight sm:text-4xl lg:text-6xl ", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("span", { className: "block uppercase text-blue-500 drop-shadow-md", children: "Tasty Tech Bytes" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("p", { className: "text-left text-xl font-extrabold tracking-tight sm:text-xl lg:text-4xl", children: [
      " ",
      "Keeping it Tasty in 2025"
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "grid lg:grid-cols-4 h-1/4 gap-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "col-span-1  h-1/4  ", children: [
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/how-to-invest-in-whisky", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-yellow-500 p-1 text-lg font-bold tracking-tight text-white", children: "Drink World - Helpful" }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-lg font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "3 Ways to Invest in Whiskey" })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/artihow-to-use-the-pie-menu-in-blender", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-purple-900 p-1 text-lg font-bold tracking-tight text-white", children: "3D World - Helpful" }),
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
            "img",
            {
              className: "items-left justify-left m-2 h-auto max-w-full flex-col rounded-full",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-lg font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "The Pie Menu Rocks in Blender" })
        ] }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "lg:col-span-2  lg:h-1/4  ", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/three-essential-webstorm-shortcuts", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-blue-500 p-1 text-lg font-bold tracking-tight text-white", children: "Software - Webstorm" }),
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
          "img",
          {
            className: "items-left justify-left m-2 h-auto max-w-full flex-col rounded-full",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-xl font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "The Three WebStorm Shortcuts to Rule Them All" }),
        " "
      ] }) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "col-span-1 h-1/4 ", children: [
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/weirdinternetfacts", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-green-400 p-1 text-lg font-bold tracking-tight text-white", children: "Code World - Random" }),
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
            "img",
            {
              className: "items-left justify-left m-2 h-auto max-w-full flex-col rounded-full",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-lg font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "4 Weird Things about the Internet" })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/nab-2023-audio-video-gear", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-red-900 p-1 text-lg font-bold tracking-tight text-white", children: "Code World - Helpful" }),
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
            "img",
            {
              className: "items-left justify-left m-2 h-auto max-w-full flex-col rounded-full",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-lg font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "Highlights from NAB 2023" })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "grid grid-cols-4 h-1/4 gap-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "col-span-1 row-span-1 ", children: [
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/threekeys-to-getting-a-frontend-or-fullstackjob", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-red-900 p-1 text-lg font-bold tracking-tight text-white", children: "Code World - Helpful" }),
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
            "img",
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-3 text-left text-lg font-bold tracking-tight shadow-none transition-shadow duration-300 ease-in-out hover:shadow-lg hover:shadow-black/30 sm:text-3xl lg:text-4xl", children: "The 3 Keys To Getting Your Dream Frontend or Full Stack Engineer Job" }),
          " "
        ] }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "col-span-1 ", children: [
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/vuejs-independant-javascript-framework", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-red-900 p-1 text-lg font-bold tracking-tight text-white", children: "Code World - Helpful" }),
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
            "img",
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-xl font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "VueJS as the Most Indie Yet Established Javascript Framework" })
        ] }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "col-span-1  ", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/astro-the-most-innovative-javascript-framwork", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-red-900 p-1 text-lg font-bold tracking-tight text-white", children: "Code World - Helpful" }),
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
          "img",
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-xl font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "Astro.js as the Most Innovative and Modern Javascript Framework" })
      ] }) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "col-span-1  ", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/the-art-of-the-clean-install", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-red-900 p-1 text-lg font-bold tracking-tight text-white", children: "Code World - Helpful" }),
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
          "img",
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-xl font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "The Art of the Clean Install" })
      ] }) }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/what-is-rag", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-purple-400 p-1 text-lg font-bold tracking-tight text-white", children: "AI Tips" }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
        "img",
        {
          className: "items-left justify-left m-2 h-auto max-w-full flex-col rounded-full",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-xl font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "RAG 101 Tutorial: All you need to know about RAG" })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/what-are-the-best-free-text-to-speech-tools", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-purple-400 p-1 text-lg font-bold tracking-tight text-white", children: "AI Tips" }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
        "img",
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-xl font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "What are the Best Free Text-to-Speech Tools? " })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/dspy101", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-purple-400 p-1 text-lg font-bold tracking-tight text-white", children: "AI Tips" }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
        "img",
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-xl font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "DSPy 101 Tutorial: Prompting Guide" })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/databricks-dspy-jetblue-ai-chatbot", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-purple-400 p-1 text-lg font-bold tracking-tight text-white", children: "AI Tips" }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
        "img",
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-xl font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: " JetBlue Optimizes Databricks LLM Pipelines with DSPy " })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/5waystoenhanceragefficiencywithdspy", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-purple-400 p-1 text-lg font-bold tracking-tight text-white", children: "AI Tips" }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
        "img",
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-xl font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: " 5 ways to enhance RAG efficiency with DSPy   " })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/threejsandweb3", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-green-800 p-1 text-lg font-bold tracking-tight text-white", children: "Code Art - ThreeJS" }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
        "img",
        {
          className: "items-left justify-left m-2 h-auto max-w-full flex-col rounded-full",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-xl font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "ThreeJS, the old Web3?" })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/easydomainverificationwithgoogle", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-red-900 p-1 text-lg font-bold tracking-tight text-white", children: "Code World - Helpful" }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
        "img",
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-xl font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "The Easy Way to Verify Domain Ownership with Google" })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/liesaboutjavascript", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-red-900 p-1 text-lg font-bold tracking-tight text-white", children: "Code World - Helpful" }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
        "img",
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-xl font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "Sweet Little JavaScript Lies About Javascript          " })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/create-your-own-huggingface-space-easy", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-red-900 p-1 text-lg font-bold tracking-tight text-white", children: "Code World - Helpful" }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
        "img",
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-lg font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "The easy way to publish on Hugging Face Spaces" })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(import_react30.Link, { to: "/5-ways-ai-can-help-farmland-restoration", children: [
      " ",
      /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
        /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "rounded-full bg-green-700 p-1 text-lg font-bold tracking-tight text-white", children: [
          " ",
          "AI & Sustainability "
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
        ...
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-xl font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "5 Ways AI Can Help Farmland Restoration " })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/models-table", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "rounded-full bg-indigo-600 p-1 text-lg font-bold tracking-tight text-white", children: [
        " ",
        "AI Models"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-lg font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "View Registered AI Models " })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react30.Link, { to: "/using-airpods-and-audacity-hack", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "transition-shadow duration-300 ease-in-out hover:bg-gray-100", children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "rounded-full bg-pink-600 p-1 text-lg font-bold tracking-tight text-white", children: "Tech World - Helpful" }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
        "img",
        {
          className: "items-left justify-left m-2 h-auto max-w-full flex-col rounded-full",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("h1", { className: "pb-4 text-left text-lg font-bold tracking-tight sm:text-3xl lg:pb-12 lg:text-4xl ", children: "AirPods Audacity: How to make AirPods(or any other bluetooth audio) work with Audacity 2023" })
    ] }) })
  ] });
}
...
// app/routes/login.tsx
var import_jsx_runtime30 = require("react/jsx-runtime"), meta10 = () => ({
  title: "Login"
});
...
function Login() {
  ...
  return import_react33.default.useEffect(() => {
  ...
  }, [actionData]), /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("div", { className: "flex min-h-full flex-col justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("div", { className: "mx-auto w-full max-w-md px-8", children: /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)(import_react34.Form, { method: "post", className: "space-y-6", noValidate: !0, children: [
    /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("label", { className: "text-sm font-medium", htmlFor: "email", children: [
        /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("span", { className: "block text-gray-700", children: "Email Address" }),
        ((_a = actionData == null ? void 0 : actionData.errors) == null ? void 0 : _a.email) && /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("span", { className: "block pt-1 text-red-700", id: "email-error", children: (_b = actionData == null ? void 0 : actionData.errors) == null ? void 0 : _b.email })
      ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("label", { className: "text-sm font-medium", htmlFor: "password", children: [
        /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("span", { className: "block text-gray-700", children: "Password" }),
        /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("span", { className: "block font-light text-gray-700", children: "Must have at least 6 characters." }),
        ((_d = actionData == null ? void 0 : actionData.errors) == null ? void 0 : _d.password) && /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("span", { className: "pt-1 text-red-700", id: "password-error", children: (_e = actionData == null ? void 0 : actionData.errors) == null ? void 0 : _e.password })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
        "input",
        {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("input", { type: "hidden", name: "redirectTo", value: redirectTo }),
    /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "text-center text-sm text-gray-500", children: [
...
function NotesPage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)("div", { className: "flex h-full min-h-screen flex-col", children: [
    /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(Header, {}),
    /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)("main", { className: "flex h-full bg-white", children: [
      /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)("div", { className: "h-full w-80 border-r bg-gray-50", children: [
        /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(import_react35.Link, { to: "new", className: "block p-4 text-xl text-blue-500", children: "+ New Note" }),
        /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("hr", {}),
        data.noteListItems.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("p", { className: "p-4", children: "No notes yet" }) : /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("ol", { children: data.noteListItems.map((note) => /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("div", { className: "flex-1 p-6", children: /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(import_react35.Outlet, {}) })
    ] })
  ] });
}
function Header() {
  let user = useUser();
  return /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)("header", { className: "flex items-center justify-between bg-slate-800 p-4 text-white", children: [
    /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("h1", { className: "text-3xl font-bold", children: /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(import_react35.Link, { to: ".", children: "Notes" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("p", { children: user.email }),
    /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(import_react35.Form, { action: "/logout", method: "post", children: /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(
      "button",
      {
        type: "submit",
...
var import_tiny_invariant5 = __toESM(require("tiny-invariant")), import_jsx_runtime32 = require("react/jsx-runtime");
...
function NoteDetailsPage2() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("h3", { className: "text-2xl font-bold", children: data.note.title }),
    /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("p", { className: "py-6", children: data.note.body }),
    /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("hr", { className: "my-4" }),
    /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(import_react36.Form, { method: "post", children: /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(
      "button",
      {
        type: "submit",
        className: "rounded bg-blue-500  py-2 px-4 text-white hover:bg-blue-600 focus:bg-blue-400",
...
var import_react37 = require("@remix-run/react"), import_jsx_runtime33 = require("react/jsx-runtime");
function NoteIndexPage() {
  return /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("p", { children: [
    "No note selected. Select a note on the left, or",
    " ",
    /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(import_react37.Link, { to: "new", className: "text-blue-500 underline", children: "create a new note." })
  ] });
}
...
var import_jsx_runtime34 = require("react/jsx-runtime"), action6 = async ({ request }) => {
...
function NewNotePage() {
  return /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)(
    import_react38.Form,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)("label", { className: "flex w-full flex-col gap-1", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)("label", { className: "flex w-full flex-col gap-1", children: [
          /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("span", { children: "Body: " }),
          /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(
            "textarea",
            {
              name: "body",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("div", { className: "text-right", children: /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(
          "button",
          {
            type: "submit",
            className: "rounded bg-blue-500  py-2 px-4 text-white hover:bg-blue-600 focus:bg-blue-400",
...
var React3 = __toESM(require("react")), import_jsx_runtime35 = require("react/jsx-runtime"), meta11 = () => ({
  title: "Sign Up"
});
...
function Join() {
  ...
  return React3.useEffect(() => {
    var _a2, _b2, _c2, _d2;
    (_a2 = actionData == null ? void 0 : actionData.errors) != null && _a2.email && ((_b2 = emailRef == null ? void 0 : emailRef.current) == null || _b2.focus()), (_c2 = actionData == null ? void 0 : actionData.errors) != null && _c2.password && ((_d2 = passwordRef == null ? void 0 : passwordRef.current) == null || _d2.focus());
  }, [actionData]), /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("div", { className: "flex min-h-full flex-col justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("div", { className: "mx-auto w-full max-w-md px-8", children: /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)(import_react39.Form, { className: "space-y-6", method: "post", noValidate: !0, children: [
    /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)("label", { className: "text-sm font-medium", htmlFor: "email", children: [
        /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("span", { className: "block text-gray-700", children: "Email Address" }),
        ((_a = actionData == null ? void 0 : actionData.errors) == null ? void 0 : _a.email) && /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("span", { className: "block pt-1 text-red-700", id: "email-error", children: (_b = actionData == null ? void 0 : actionData.errors) == null ? void 0 : _b.email })
      ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)("label", { className: "text-sm font-medium", htmlFor: "password", children: [
        /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("span", { className: "block text-gray-700", children: "Password" }),
        /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("span", { className: "block font-light text-gray-700", children: "Must have at least 6 characters." }),
        ((_d = actionData == null ? void 0 : actionData.errors) == null ? void 0 : _d.password) && /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("span", { className: "pt-1 text-red-700", id: "password-error", children: (_e = actionData == null ? void 0 : actionData.errors) == null ? void 0 : _e.password })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(
        "input",
        {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("input", { type: "hidden", name: "redirectTo", value: redirectTo }),
    /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)("div", { className: "text-center text-sm text-gray-500", children: [
